...
if(window["000a0180686911e78dd0a45d36bb8c5c"] === undefined)
{
	 ...
	 * @param {string} cookie - 自定义数据 (在回调时，回传给调用者)
	 */	
	CRVideo_StopMeeting = function(meetID,cookie)
	{
		if(cookie === undefined)
		{
			cookie = "";
	 ...
	 */	
	CRVideo_StartPcmRecord = function(recordObject,filePathName)
	{
	 ...
	 * @param 无返回值
	 */
	 CRVideo_StopPcmRecord = function(type)
	{
	 ...
	 */
	CRVideo_Switchtopage = function(mainPage,jsonSubPage)
	{
	 ...
	 */
	CRVideo_Createboard = function(title,width,height,imgFileID)
	{
	 ...
	 */
	CRVideo_Closeboard = function(jsonBoardID)
	{
	 ...
	 * @returns {string}
	 */
	CRVideo_Addboardelement = function(jsonBoardID,elementData)
	{
	 ...
	 */
	CRVideo_Delboardelement = function(jsonBoardID,jsonElementIDs)
	{
	 ...
	 * @param {number} y - 屏幕纵坐标
	 */
	CRVideo_Setmousehotspot = function(jsonBoardID,x,y)
	{
