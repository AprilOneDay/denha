...
(function ($, window, document, undefined) {
     ...
     *              <div class="dd"></div>
     *              <div class="label label-dd">days</div>
     *          </div>
     *          <div class="separator separator-dd">,</div>
     *          <div class="item item-hh">
     *              <div class="hh-1"></div>
     *              <div class="hh-2"></div>
     *              <div class="label label-hh">hours</div>
     *          </div>
     *          <div class="separator">:</div>
     *          <div class="item item-mm">
     *              <div class="mm-1"></div>
     *              <div class="mm-2"></div>
     *              <div class="label label-mm">minutes</div>
     *          </div>
     *          <div class="separator">:</div>
     *          <div class="item item-ss">
     *              <div class="ss-1"></div>
     *              <div class="ss-2"></div>
     *              <div class="label label-ss">seconds</div>
     *          </div>
     *      </time>
     */
    ...
    $.extend(CountDown.prototype, {
        ...
        markup: function () {
            ...
            var html = [
                ...
                '</div>',
                '<div class="separator separator-dd">', this.options.separator_days, '</div>',
                '<div class="item item-hh">',
					'<div class="divhh">',
                    '<div class="hh-1 time_span"></div>',
                    '<div class="hh-2 time_span"></div>',
					'</div>',
                    '<div class="label label-hh">时</div>', 	'<div class="separator">:</div>',
                '</div>',
         
                '<div class="item item-mm">',
					'<div class="divhh ">',
                    '<div class="mm-1 time_span"></div>',
                    '<div class="mm-2 time_span"></div>',
					'</div>',
                    '<div class="label label-mm">分</div>', '<div class="separator">:</div>',
                '</div>',
             
                '<div class="item item-ss">',
					'<div class="divhh">',
                    '<div class="ss-1 time_span"></div>',
                    '<div class="ss-2 time_span"></div>',
					'</div>',
                    '<div class="label label-ss">秒</div>',
					 '<div class="separator">:</div>',
                '</div>',
