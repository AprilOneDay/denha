...
MySQL - 5.5.53-log : Database - blog
*********************************************************************
*/
...
CREATE TABLE `dh_article_course` (
  ...
  `live_code` varchar(100) DEFAULT NULL COMMENT '直播房间id',
  PRIMARY KEY (`id`)
...
insert  into `dh_article_course_schedule`(`id`,`start_time`,`end_time`,`credit`,`teacher_hour`) values (47,1511342760,1511353560,0,4),(47,1510910760,1510918080,0,3),(24,1509443640,1510910760,10,0),(24,1507629240,1510910760,10,0),(47,1510824360,1510831560,0,2),(47,1510588800,1510651560,0,1),(59,1511366400,1511370120,2,0),(59,1511712000,1511715720,2,0);
...
insert  into `dh_console_admin`(`id`,`consoleid`,`nickname`,`username`,`password`,`salt`,`mobile`,`status`,`group`,`create_ip`,`login_ip`,`created`,`login_time`) values (1,0,'四月','admin','8895c4947031a4019843c0d00fa303b1','50907','15923882847',1,1,'127.0.0.1','127.0.0.1',1502522576,1511330291),(4,0,'四月2','lingsi','b91935189cc2442e45d86a4d0dbf8a9c','34366','15923882847',1,2,'127.0.0.1','127.0.0.1',1502531990,1509696854),(5,0,'四月22','lingsi2','b8754f152f17cc72a63e6a42908ddd9b','17676','124567890',1,2,'127.0.0.1','0',1509697537,0);
...
insert  into `dh_console_group`(`id`,`name`,`power`,`status`,`level`) values (1,'超级管理员','1,2,3,4,5,35,6,7,8,10,17,11,12,13,14,15,16,18,28,19,20,21,22,23,24,25,26,27,29,30,31,33,34,32,38,39,36,37,40,41,42,43,44',1,0),(2,'运营组','1,2,35,6,7,10,17,13,14,15,16,18,28,19,20,21,22,23,24,25,26,27,29,30,31,33,34,32',1,1);
...
CREATE TABLE `dh_footprints` (
  ...
  KEY `created` (`created`),
  KEY `value2` (`value2`)
) ENGINE=InnoDB AUTO_INCREMENT=36 DEFAULT CHARSET=utf8 COMMENT='用户浏览记录';
...
CREATE TABLE `dh_orders_course` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='课程表';

/*Data for the table `dh_orders_course` */

insert  into `dh_orders_course`(`id`,`teacher_uid`,`order_sn`,`title`,`btitle`,`goods_id`,`sign`,`num`,`class_time`,`class_time_en`,`thumb`,`nickname`,`mobile`) values (13,8,'173175139456615895','雅思7.5分精品课程','雅思7.5分精品课程',47,1,6,'上课时间中文','上课时间英文','6109903a4f0399518bc5829b01559ccc.jpeg','哈哈哈','11111'),(15,8,'173253093980531653','测试','',59,1,0,'','','','17300289310','17300289310'),(14,8,'173200718493192019','雅思7.5分精品课程','雅思7.5分精品课程',47,1,6,'上课时间中文','上课时间英文','6109903a4f0399518bc5829b01559ccc.jpeg','哈哈哈','123445');
...
CREATE TABLE `dh_sms_verify` (
  ...
  KEY `created` (`created`)
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='短信验证码记录';

/*Data for the table `dh_sms_verify` */

insert  into `dh_sms_verify`(`id`,`mobile`,`code`,`created`) values (4,'15923882847','69620',1511323222),(2,'18523563220','35080',1511332919),(5,'18725796416','48179',1508757424),(6,'13896568031','46449',1511333748);
...
insert  into `dh_user`(`id`,`type`,`uid`,`username`,`nickname`,`real_name`,`avatar`,`mobile`,`mail`,`password`,`address`,`salt`,`token`,`time_out`,`ip`,`integral`,`status`,`del_status`,`login_ip`,`login_time`,`created`,`is_message`,`version`,`imei`) values (1,2,185687,'cheng6251','零零距离','四月','151071464170191.jpeg','13425778542','','8716773dd45d75071f72af288df92cbc','','26979','9a019ce3a1cd7e2570f7618637c9c771',