...
insert  into `dh_article`(`id`,`type`,`tag`,`title`,`thumb`,`description`,`is_show`,`del_status`,`created`,`hot`,`is_recommend`) values (1,1,'6','Nginx 实现跨域使用字体文件','','Nginx 实现跨域使用字体文件',1,0,1504970134,14,1),(2,1,'6','Nginx 跨域访问php  ','','Access-Control-Allow-Origin 错误',1,0,1504970371,35,0),(3,1,'10','Html 文字内容只显示一行','','css控制文字内容只显示一行',1,0,1505020972,156,0);
...
insert  into `dh_comment`(`id`,`type`,`uid`,`parent_id`,`to_uid`,`content`,`del_status`,`order_sn`,`goods_id`,`ablum`,`status`,`is_uid_reader`,`is_to_uid_reader`,`created`) values (1,1,3,0,4,'这是我发布的第一天评论',0,'',1,'',1,0,0,1506327966),(2,1,3,0,4,'这是我发布的第一天评论',0,'',1,'',1,0,0,1506327999),(3,1,4,2,4,'这是我发布的第一天评论',0,'',1,'',1,0,0,1506328046),(4,1,3,2,4,'这是我发布的第一天评论',0,'',1,'',1,0,0,1506328046),(5,1,3,2,4,'这是我发布的第一天评论',0,'',1,'',1,0,0,1506328046),(6,1,3,2,4,'这是我发布的第一天评论',0,'',1,'',1,0,0,1506328046),(8,2,4,0,1,'啊啊啊啊啊',0,'172646797722115621',2,'',1,0,0,1506503620),(10,2,4,0,1,'啊啊啊啊啊',0,'172646797722115621',2,'',1,0,0,1506504617),(11,1,2,0,4,'这是我的评论',0,'',1,'',1,0,0,1506566061),(12,1,3,0,2,'这是第一条评论',0,'',4,'',1,0,0,1506580025),(13,1,2,12,3,'这是我的回复信息',0,'',4,'',1,0,0,1506583717),(14,1,2,4,3,'哈哈哈',0,'',1,'',1,0,0,1506584079),(15,1,2,0,2,'明年',0,'',4,'',1,0,0,1506584114),(16,1,2,4,3,'回复一次',0,'',1,'',1,0,0,1506584137),(17,1,3,4,2,'多试一下',0,'',1,'',1,0,0,1506586051),(18,1,3,4,2,'我要成功',0,'',1,'',1,0,0,1506586384),(19,1,2,12,3,'再试一次',0,'',4,'',1,0,0,1506586970),(20,1,2,12,3,'最后一个',0,'',4,'',1,0,0,1506587332),(21,1,2,0,2,'回复所有人',0,'',4,'',1,0,0,1506588087),(22,2,2,0,3,'好吃吗，还不错',0,'172670845735945735',5,'150667774515869.jpeg,150667774532563.jpeg',1,0,0,1506677745),(23,2,2,0,3,'评价回复',0,'172717592252214453',1,'150667794196918.jpeg',1,0,0,1506677941);
...
insert  into `dh_footprints`(`id`,`uid`,`type`,`value`,`value2`,`del_status`,`ip`,`created`) values (3,1,1,1,'1',0,'127.0.0.1',1505966052),(4,2,1,8,'3',0,'127.0.0.1',1506649660),(5,4,1,2,'1',0,'127.0.0.1',1506065062),(6,2,1,5,'3',0,'127.0.0.1',1506737017),(7,2,1,3,'3',0,'127.0.0.1',1506582976),(8,4,1,1,'1',0,'127.0.0.1',1506303637);
...
) ENGINE=InnoDB AUTO_INCREMENT=66 DEFAULT CHARSET=utf8 COMMENT='积分详情';
...
CREATE TABLE `dh_search_disable` (
  ...
  KEY `value` (`value`),
  KEY `type` (`type`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='搜索禁用';
...
CREATE TABLE `dh_search_log` (
  ...
  KEY `keyword` (`value`),
  KEY `type` (`type`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='搜索记录';

/*Data for the table `dh_search_log` */

insert  into `dh_search_log`(`id`,`type`,`value`,`uid`,`created`,`hot`) values (2,1,'奥迪',0,1505875793,2),(3,1,'大众',0,1505876306,5),(4,1,'大众',1,1505876338,2),(5,1,'html',0,1506590163,1),(6,1,'111',0,1506739702,3),(7,1,'四月工作室',0,1506740474,3);
...
insert  into `dh_shop_hot_log`(`id`,`uid`,`num`,`time`) values (1,1,2,'2017-09-21'),(2,2,22,'2017-09-22'),(3,4,2,'2017-09-22'),(4,4,1,'2017-09-25'),(5,2,4,'2017-09-25'),(6,2,3,'2017-09-28'),(7,2,2,'2017-09-29'),(8,2,1,'2017-09-30');
...
insert  into `dh_user`(`id`,`type`,`username`,`nickname`,`avatar`,`mobile`,`mail`,`password`,`salt`,`token`,`time_out`,`ip`,`integral`,`status`,`del_status`,`login_ip`,`login_time`,`created`,`is_message`,`version`,`imei`) values (1,2,'cheng6251','cheng6251','150631954346095.jpeg','13425778542','','7df8faa9a5f71811689662131b7f9fe5','45452','11b141ff4386fb2b8062cad3df260a6d',1506847805,'127.0.0.1',100000,1,0,'127.0.0.1',1506304319,1505292648,1,0,''),(2,1,'weixuelin','魏雪林','150631954346095.jpeg','18523563220','6497646qw@163.com','f6b81aa9bcdeb6e01455a3d61e16f4d7','21749','1ea0610b97ce9e15e511efe0ebaef42a',1506923822,'127.0.0.1',96060,1,0,'127.0.0.1',1506751017,1505293289,1,0,'ceadcf79f7ed11e1'),(3,2,'kuangxin','kuangxin','150631954346095.jpeg','13896568031','','01bafc44de12208bb48680dca2ea4c16','12532','5a3243477f3009a2d9bd1bdfc845b1fd',1506933093,'127.0.0.1',100000,1,0,'127.0.0.1',1506760291,1505368006,1,0,'ceadcf79f7ed11e1'),(4,1,'四月个人用户','四月个人用户','150631954346095.jpeg','15923882847','','ffbb0d9f227b1d1df90513144b3b73ad','14526','70c7fe7fc8626d165bacfe627a33d348',1506844522,'127.0.0.1',98000,1,0,'127.0.0.1',1506671722,1506063155,1,0,''),(5,1,'123456','123456','','15923882847','','509849f59071c6829ea94459620d9026','59117','',0,'127.0.0.1',100000,1,0,'',0,1506395554,1,0,''),(6,1,'1234567','1234567','','15923882847','','de7a8d21b859e33d6fbee46781a4e08d','50621','',0,'127.0.0.1',100000,1,0,'',0,1506395715,1,0,'');
