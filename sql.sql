...
CREATE TABLE `dh_chat_log` (
  ...
  KEY `created` (`created`)
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='聊天记录';

/*Data for the table `dh_chat_log` */

insert  into `dh_chat_log`(`id`,`uid`,`to_uid`,`content`,`is_reader`,`created`) values (1,2,3,'这是我的回复信息',1,1506585491),(2,2,3,'这是我的回复信息',1,1506585529),(3,2,3,'啦咯啦咯来咯啦咯啦咯啦咯',1,1507520456),(4,2,4,'你明明',1,1507533768),(5,2,3,'hhhvvgg',1,1507780095),(6,1,2,'在么？',1,1507786921),(7,1,2,'在么？',1,1507786932),(8,2,1,'在的亲',1,1507787075);
...
insert  into `dh_enjoy`(`id`,`type`,`value`,`uid`,`created`) values (3,1,'2',2,1506577947),(4,1,'3',2,1506577953),(7,1,'4',2,1506587887),(8,1,'1',3,1507689475),(9,1,'4',3,1507689478);
...
CREATE TABLE `dh_footprints` (
  ...
  KEY `created` (`created`),
  KEY `value2` (`value2`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='用户浏览记录';

/*Data for the table `dh_footprints` */

insert  into `dh_footprints`(`id`,`uid`,`type`,`value`,`value2`,`del_status`,`ip`,`created`) values (3,1,1,1,'1',0,'127.0.0.1',1507692707),(4,2,1,8,'3',0,'127.0.0.1',1507534075),(5,4,1,2,'1',0,'127.0.0.1',1506065062),(6,2,1,5,'3',0,'127.0.0.1',1506737017),(7,2,1,3,'3',0,'127.0.0.1',1506582976),(8,4,1,1,'1',0,'127.0.0.1',1506303637),(9,2,1,18,'2',0,'127.0.0.1',1507534083),(10,2,1,15,'4',0,'127.0.0.1',1507534150),(11,2,1,17,'2',0,'127.0.0.1',1507534104),(12,2,1,11,'1',0,'127.0.0.1',1507533749),(13,2,1,13,'4',0,'127.0.0.1',1507533764),(14,2,1,16,'2',0,'127.0.0.1',1507534978),(15,1,1,5,'3',0,'127.0.0.1',1507622804),(16,3,1,8,'3',0,'127.0.0.1',1507780090);
...
insert  into `dh_shop_hot_log`(`id`,`uid`,`num`,`time`) values (12,3,1,'2017-10-12'),(11,1,1,'2017-10-11');
...
insert  into `dh_user`(`id`,`type`,`username`,`nickname`,`avatar`,`mobile`,`mail`,`password`,`salt`,`token`,`time_out`,`ip`,`integral`,`status`,`del_status`,`login_ip`,`login_time`,`created`,`is_message`,`version`,`imei`) values (1,2,'cheng6251','四月工作室','150768888516204.png','13425778542','','7df8faa9a5f71811689662131b7f9fe5','45452','11b141ff4386fb2b8062cad3df260a6d',1507959920,'127.0.0.1',100000,1,0,'127.0.0.1',1506304319,1505292648,1,0,''),(2,1,'weixuelin','魏雪林','150631954346095.jpeg','18523563220','6497646qw@163.com','f6b81aa9bcdeb6e01455a3d61e16f4d7','21749','d97e4b9b2e412459b85df7daa13ca8aa',1507960094,'127.0.0.1',96060,1,0,'127.0.0.1',1507780087,1505293289,1,0,'ceadcf79f7ed11e1'),(3,2,'kuangxin','kuangxin','150631954346095.jpeg','13896568031','','01bafc44de12208bb48680dca2ea4c16','12532','1cf30c9adf8b70ef72c42e588d3f8064',1507952957,'127.0.0.1',100030,1,0,'127.0.0.1',1507780150,1505368006,1,0,'ceadcf79f7ed11e1'),(4,1,'四月个人用户','四月个人用户','150631954346095.jpeg','15923882847','','ffbb0d9f227b1d1df90513144b3b73ad','14526','70c7fe7fc8626d165bacfe627a33d348',1506844522,'127.0.0.1',98000,1,0,'127.0.0.1',1506671722,1506063155,1,0,''),(5,1,'123456','123456','','15923882847','','509849f59071c6829ea94459620d9026','59117','',0,'127.0.0.1',100000,1,0,'',0,1506395554,1,0,''),(6,1,'1234567','1234567','','15923882847','','de7a8d21b859e33d6fbee46781a4e08d','50621','',0,'127.0.0.1',100000,1,0,'',0,1506395715,1,0,'');
...
insert  into `dh_user_message`(`id`,`type`,`uid`,`to_uid`,`content`,`jump_app`,`is_reader`,`del_status`,`created`) values (1,1,0,3,'恭喜你成为会员,祝你购车愉快','',0,0,1506395554),(2,1,0,4,'恭喜你成为会员,祝你购车愉快','',0,0,1506395715),(3,3,1,2,'你有新的消息','',0,0,1507786932),(4,3,2,1,'你有新的消息','',0,0,1507787075);
