...
MySQL - 5.5.53-log : Database - hengdin
*********************************************************************
*/
...
insert  into `dh_article_download`(`id`,`down_url`) values (60,'/uploadfile/test/151178135624664.zip,/uploadfile/test/151178135730629.zip'),(61,'/uploadfile/test/151178135624664.zip,/uploadfile/test/151178135730629.zip');
...
CREATE TABLE `dh_exam_data` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='考卷题目';

/*Data for the table `dh_exam_data` */

insert  into `dh_exam_data`(`id`,`exam_id`,`type`,`title`,`content`,`del_status`,`sort`) values (3,6,2,'123','[{\"answer\":\"1111\",\"is_answer\":\"1\"},{\"answer\":\"2344\",\"is_answer\":\"0\"},{\"answer\":\"23444556\",\"is_answer\":\"1\"}]',0,0);
...
CREATE TABLE `dh_upload_log` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `type` tinyint(4) DEFAULT '1' COMMENT '类型 1图片 2附件',
  `ext` varchar(10) DEFAULT '' COMMENT '后缀',
  `name` varchar(200) DEFAULT '' COMMENT '源文件名称',
  `path` varchar(300) DEFAULT '' COMMENT '保存文件',
  `url` varchar(300) DEFAULT '' COMMENT '文件url地址',
  `created` int(11) DEFAULT '0' COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COMMENT='附件上传记录';
