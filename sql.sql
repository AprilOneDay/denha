...
insert  into `dh_console_admin`(`id`,`consoleid`,`nickname`,`username`,`password`,`salt`,`mobile`,`status`,`group`,`create_ip`,`login_ip`,`created`,`login_time`) values (1,0,'四月','admin','8895c4947031a4019843c0d00fa303b1','50907','15923882847',1,1,'127.0.0.1','127.0.0.1',1502522576,1511922826),(4,0,'四月2','lingsi','b91935189cc2442e45d86a4d0dbf8a9c','34366','15923882847',1,2,'127.0.0.1','127.0.0.1',1502531990,1509696854),(5,0,'四月22','lingsi2','b8754f152f17cc72a63e6a42908ddd9b','17676','124567890',1,2,'127.0.0.1','0',1509697537,0);
...
CREATE TABLE `dh_upload_log` (
  ...
  `created` int(11) unsigned DEFAULT '0' COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=18 DEFAULT CHARSET=utf8mb4 COMMENT='附件上传记录';

/*Data for the table `dh_upload_log` */

insert  into `dh_upload_log`(`id`,`ext`,`name`,`size`,`path`,`url`,`created`) values (17,'zip','002.zip',13386,'test','1511948364644_17.zip',1511948364),(16,'zip','002.zip',13386,'test','1511948358134_16.zip',1511948358),(15,'zip','002.zip',13386,'test','1511948337489_1.zip',1511948337);
