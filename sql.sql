...
insert  into `dh_article_course_schedule`(`id`,`start_time`,`end_time`,`credit`,`teacher_hour`) values (47,1511342760,1511353560,0,4),(47,1510910760,1510918080,0,3),(24,1509443640,1510910760,10,0),(24,1507629240,1510910760,10,0),(47,1510824360,1510831560,0,2),(47,1510588800,1510651560,0,1);
...
insert  into `dh_article_teacher`(`id`,`teacher_uid`,`position`,`position_en`) values (16,1,'深知高数讲师','Know high number of lecturers'),(36,1,'高级数学导师','Senior Math Teacher'),(39,1,'',''),(38,1,'',''),(40,1,'',''),(37,1,'',''),(41,1,'','');
...
insert  into `dh_banner_data`(`id`,`banner_id`,`path`,`description`,`sort`) values (2,1,'4eb18891b7bff8e89da7bcda5e3b6741.jpeg','222',0),(3,1,'43bc6adcffe0be147572626263455e2d.jpeg','2222',3);
...
insert  into `dh_console_admin`(`id`,`consoleid`,`nickname`,`username`,`password`,`salt`,`mobile`,`status`,`group`,`create_ip`,`login_ip`,`created`,`login_time`) values (1,0,'四月','admin','8895c4947031a4019843c0d00fa303b1','50907','15923882847',1,1,'127.0.0.1','127.0.0.1',1502522576,1510909910),(4,0,'四月2','lingsi','b91935189cc2442e45d86a4d0dbf8a9c','34366','15923882847',1,2,'127.0.0.1','127.0.0.1',1502531990,1509696854),(5,0,'四月22','lingsi2','b8754f152f17cc72a63e6a42908ddd9b','17676','124567890',1,2,'127.0.0.1','0',1509697537,0);
...
insert  into `dh_console_group`(`id`,`name`,`power`,`status`,`level`) values (1,'超级管理员','1,2,3,4,5,35,6,7,8,10,17,11,12,13,14,15,16,18,28,19,20,21,22,23,24,25,26,27,29,30,31,33,34,32,38,39,36,37,40,41,42,43',1,0),(2,'运营组','1,2,35,6,7,10,17,13,14,15,16,18,28,19,20,21,22,23,24,25,26,27,29,30,31,33,34,32',1,1);
...
insert  into `dh_console_parameter`(`id`,`type`,`name`,`value`,`option`) values (1,1,'车行汽车交易佣金(百分比)','4',''),(2,1,'公司电话','',''),(3,1,'公司地址','',''),(4,1,'公司地址英文','','');
...
CREATE TABLE `dh_coupon` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='抵扣卷模板';

/*Data for the table `dh_coupon` */

insert  into `dh_coupon`(`id`,`type`,`category`,`uid`,`title`,`full`,`less`,`discount`,`num`,`start_time`,`end_time`,`status`,`remainder_num`,`del_status`,`created`,`is_exchange`,`version`) values (2,1,23,1,'5折优惠卷','10','5',0,100,1505701881,1510329600,1,92,0,1506411977,1,9),(3,1,21,1,'5折优惠卷','1000','100',0,100,1505701881,1507564800,1,98,0,1506411977,1,9),(4,1,20,3,'满100减10','200','5',0,400,1509465600,1512057600,1,398,0,1506483325,1,3),(5,2,20,3,'这个是名称','0','0',8,55,1506787200,1509465600,1,300,0,1506483455,1,1),(6,1,21,1,'5折优惠卷','1000','100',0,100,1505701881,1507564800,1,100,0,1506491073,1,1),(7,1,21,1,'5折优惠卷','1000','100',0,100,1505701881,1507564800,1,100,0,1506491125,1,1),(8,1,23,3,'满100减5','100','5',0,200,1506528000,1506700800,1,199,0,1506562539,1,2),(9,2,21,1,'11111','0','0',5,100,2024,2026,1,100,0,1509086696,1,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=52 DEFAULT CHARSET=utf8 COMMENT='抵扣卷列表';

/*Data for the table `dh_coupon_log` */

insert  into `dh_coupon_log`(`id`,`uid`,`coupon_id`,`order_sn`,`use_time`,`created`,`origin`) values (48,4,2,'0',0,1508914728,2),(49,4,2,'0',0,1508915046,2),(50,4,2,'0',0,1508915047,2),(51,7,4,'0',0,1510650815,2);
...
CREATE TABLE `dh_footprints` (
  ...
  KEY `created` (`created`),
  KEY `value2` (`value2`)
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8 COMMENT='用户浏览记录';

/*Data for the table `dh_footprints` */

insert  into `dh_footprints`(`id`,`uid`,`type`,`value`,`value2`,`del_status`,`ip`,`created`) values (3,1,1,1,'1',0,'127.0.0.1',1508220861),(4,2,1,8,'3',0,'127.0.0.1',1510815485),(5,4,1,2,'1',0,'127.0.0.1',1506065062),(6,2,1,5,'3',0,'127.0.0.1',1510815012),(7,2,1,3,'3',0,'127.0.0.1',1506582976),(8,4,1,1,'1',0,'127.0.0.1',1506303637),(9,2,1,18,'2',0,'127.0.0.1',1507877617),(10,2,1,15,'4',0,'127.0.0.1',1507534150),(11,2,1,17,'2',0,'127.0.0.1',1507877223),(12,2,1,11,'1',0,'127.0.0.1',1510815003),(13,2,1,13,'4',0,'127.0.0.1',1507533764),(14,2,1,16,'2',0,'127.0.0.1',1507534978),(15,1,1,5,'3',0,'127.0.0.1',1507622804),(16,3,1,8,'3',0,'127.0.0.1',1507888057),(17,4,1,15,'4',0,'127.0.0.1',1507875418),(18,1,1,11,'1',0,'127.0.0.1',1507877804),(19,7,1,19,'7',0,'127.0.0.1',1507877563),(20,3,1,3,'3',0,'127.0.0.1',1507886104),(21,3,1,5,'3',0,'127.0.0.1',1507887044),(22,4,1,14,'4',0,'127.0.0.1',1508147580),(23,2,1,1,'1',0,'127.0.0.1',1510814930),(24,7,1,5,'3',0,'127.0.0.1',1510647052),(25,7,1,20,'12',0,'127.0.0.1',1510650495),(26,12,1,20,'12',0,'127.0.0.1',1510649215),(27,7,1,21,'7',0,'127.0.0.1',1510650491),(28,12,1,21,'7',0,'127.0.0.1',1510649201),(29,7,1,11,'1',0,'127.0.0.1',1510652374),(30,7,1,10,'1',0,'127.0.0.1',1510651390),(31,2,1,23,'2',0,'127.0.0.1',1510814899),(32,2,1,21,'7',0,'127.0.0.1',1510814905),(33,2,1,7,'1',0,'127.0.0.1',1510814923);
...
CREATE TABLE `dh_goods_car` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8 COMMENT='新车信息';

/*Data for the table `dh_goods_car` */

insert  into `dh_goods_car`(`id`,`type`,`uid`,`title`,`thumb`,`brand`,`style`,`produce_time`,`model`,`buy_time`,`mileage`,`city`,`gearbox`,`gases`,`displacement`,`model_remark`,`price`,`vin`,`guarantee`,`is_lease`,`mobile`,`weixin`,`qq`,`address`,`description`,`banner`,`status`,`hot`,`is_recommend`,`is_urgency`,`is_show`,`created`) values (1,2,1,'奥迪 2013 A6L 1.6L 纪念版2','150578956279606.png',1,'A6L',2013,' 三厢',2017,1.2,'5','自动','国V','1.6L','纪念版2','18.00','111111','3',0,'15923882847','weixin','qq','这里是测试地址信息的','这里是输入商品详情的地方11111','150578956279606.png,150578956240119.jpeg',1,14,0,0,1,1505701881),(2,2,1,'奥迪 2013 A6L 1.6L 纪念版2','150578956279606.png',1,'A6L',2013,' 三厢',2017,1.2,'5','自动','国V','1.6L','纪念版2','18.00','111111','3',0,'15923882847','weixin','qq','这里是测试地址信息的','','150578956279606.png,150578956240119.jpeg',1,24,0,0,1,1505701942),(3,2,3,'大众 2017 x5 2.0 很好','150596096890834.jpeg',3,'x5',2017,'2',1420041600,2.0,'14','2','2','2.0','很好','20.00','888888','0',1,'','','','','九成新，值得入手','',1,2,1,1,1,1505706388),(4,2,1,'汽车品牌 2013 A6L 1.6L 纪念版2','150596096890834.jpeg',1,'A6L',2013,' 三厢',1420041600,1.2,'14','自动','国V','1.6L','纪念版2','18.00','111111','0',0,'15923882847','weixin','qq','这里是测试地址信息的','这里是输入商品详情的地方','',1,1,0,0,1,1505706629),(5,2,3,'奥迪 2017 23 888 很好','150596096890834.jpeg',2,'23',2017,'1',1420041600,5.0,'14','2','1','888','很好','5.00','88888996','0',0,'','','','','很好的啦','',1,7,1,1,1,1505706882),(6,2,1,'汽车品牌 2013 A6L 1.6L 纪念版2','150596096890834.jpeg',1,'A6L',2013,' 三厢',1420041600,1.2,'14','自动','国V','1.6L','纪念版2','18.00','111111','0',0,'15923882847','weixin','qq','这里是测试地址信息的','这里是输入商品详情的地方11111','150580886964585.png,150580886964659.jpeg',1,3,0,0,1,1505808869),(7,2,1,'汽车品牌 2013 A6L 1.6L 纪念版2','150596096890834.jpeg',1,'A6L',2013,' 三厢',1420041600,1.2,'14','自动','国V','1.6L','纪念版2','18.00','111111','0',0,'15923882847','weixin','qq','这里是测试地址信息的','这里是输入商品详情的地方11111','150580908058688.png,150580908096283.jpeg',1,3,0,0,1,1505809080),(8,2,3,'奥迪 2017 x6 2.0 很好的汽车，九成新','150587084744692.png',2,'x6',2017,'5',1420041600,5.0,'14','1','1','2.0','很好的汽车，九成新','20.00','66666666','0',0,'','','','','很好哦，九成新，值得入手，不要犹豫','150587084744692.png,150587084733090.png',1,6,1,1,1,1505870847),(9,2,1,'汽车品牌 2013 A6L 1.6L 纪念版2','150596096890834.jpeg',1,'A6L',2013,' 三厢',2017,1.2,'5','自动','国V','1.6L','纪念版2','18.00','111111','0',0,'15923882847','weixin','qq','这里是测试地址信息的','这里是输入商品详情的地方11111','',1,21,0,0,1,1505960899),(10,2,1,'汽车品牌 2013 A6L 1.6L 纪念版2','150596096890834.jpeg',1,'A6L',2013,' 三厢',2017,1.2,'5','自动','国V','1.6L','纪念版2','18.00','111111','0',0,'15923882847','weixin','qq','这里是测试地址信息的','这里是输入商品详情的地方11111','150596096890834.jpeg,150596096837567.jpeg,150596096889744.png',1,6,0,0,1,1505960968),(11,2,1,'汽车品牌 2013 A6L 1.6L 纪念版2','150908448373047.jpeg',1,'A6L',2013,' 三厢',1970,1.2,'5','自动','国V','1.6L','纪念版2','18.00','111111','',0,'','','','','这里是输入商品详情的地方11111','150908448373047.jpeg,150908448396094.jpeg',1,6,0,0,1,1505961155),(12,1,4,'汽车品牌 2013 A6L 1.6L 纪念版2','150641899599456.png',1,'A6L',2013,' 三厢',2017,1.2,'5','自动','国V','1.6L','纪念版2','18.00','111111','0',0,'15923882847','weixin','qq','这里是测试地址信息的','这里是输入商品详情的地方11111','150641899599456.png,150641899599165.png,150641899581683.png',1,1,0,0,1,1506418995),(13,1,4,'汽车品牌 2013 A6L 1.6L 纪念版2','150641904739627.png',1,'A6L',2013,' 三厢',2017,1.2,'5','自动','国V','1.6L','纪念版2','18.00','111111','0',0,'15923882847','weixin','qq','这里是测试地址信息的','这里是输入商品详情的地方11111','150641904739627.png,150641904789466.png,150641904730885.png',1,9,0,0,1,1506419047),(14,1,4,'汽车品牌 2013 A6L 1.6L 纪念版2','150641910488810.png',1,'A6L',2013,' 三厢',2017,1.2,'5','自动','国V','1.6L','纪念版2','18.00','111111','0',0,'15923882847','weixin','qq','这里是测试地址信息的','这里是输入商品详情的地方11111','150641910488810.png,150641910457982.png,150641910411562.png',1,1,0,0,1,1506419104),(15,1,4,'汽车品牌 2013 A6L 1.6L 纪念版2','150641947515130.png',1,'A6L',2013,' 三厢',2017,1.2,'5','自动','国V','1.6L','纪念版2','18.00','111111','0',0,'15923882847','weixin','qq','这里是测试地址信息的','这里是输入商品详情的地方11111','150641947515130.png,150641947565011.png,150641947546598.png',1,5,0,0,1,1506419475),(16,1,2,'奥迪 2017 j6','150641999361907.jpeg',2,'j6',2017,'',1504195200,6.0,'4','','','','','13.00','','0',0,'','','','','','150641999361907.jpeg,150641999321747.jpeg,150641999369548.jpeg',1,11,0,0,1,1506419993),(17,1,2,'奥迪 2017 l6 6 备注','150642085932332.png',2,'l6',2017,'2',1504195200,6.0,'4','2','1','6','备注','13.00','kdkxjxj','0',0,'','','','','差个明模式我说问一下','150642085932332.png,150642085925946.png,150642085922650.png',2,1,0,0,1,1506420859),(18,1,2,'奥迪 2017 c6 6 备注啦啦','150647576838026.jpeg',2,'c6',2017,'1',1501516800,5.0,'2','2','1','6','备注啦啦','13.00','646797997','0',0,'','','','','详细备注，让客户更好了解车子','150647576838026.jpeg,150647576843596.jpeg,150647576844041.jpeg',1,3,0,0,1,1506475768),(19,1,7,'宝马 2017 方法个 1.6','150787632875679.jpeg',25,'方法个',2017,'1',1412092800,1.0,'1','1','1','1.6','','200000.00','地方呵呵','0',0,'','','','','','150787632875679.jpeg,150787632875775.jpeg',2,8,1,1,1,1507876328),(20,1,12,'奥拓 2016 j\'k jlade','151064777164956.jpeg',2,'j\'k',2016,'轿车',0,5.0,'18','','','','jlade','42696.00','','0',0,'','','','','kleddefenjjkkkl','151064777164956.jpeg',1,9,0,0,1,1510647771),(21,1,7,'大众 2010 Gg SDgf','151064783460072.jpeg',3,'Gg',2010,'2',1501516800,2.0,'10','','','','SDgf','57888.00','','0',0,'','','','','DffFggggvvbbv','151064783460072.jpeg',1,7,0,0,1,1510647833),(22,1,7,'奥拓 1995 jk','151071339053179.jpeg',2,'jk',1995,'两厢',0,5.0,'11','','','','','556555.00','','0',0,'','','','','','151071339053179.jpeg',1,6,0,0,1,1510713390),(23,1,2,'大众 井口 3000-5000','151080029794413.jpeg',3,'井口',0,'',0,0.0,'15','100-20','','3000-5000','','55566.00','','0',0,'','','','','','151080029794413.jpeg',1,6,0,0,1,1510800297);
...
CREATE TABLE `dh_orders_course` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='课程表';

/*Data for the table `dh_orders_course` */

insert  into `dh_orders_course`(`id`,`teacher_uid`,`order_sn`,`title`,`btitle`,`goods_id`,`sign`,`num`,`class_time`,`class_time_en`,`thumb`,`nickname`,`mobile`) values (13,8,'173175139456615895','雅思7.5分精品课程','雅思7.5分精品课程',47,1,6,'上课时间中文','上课时间英文','6109903a4f0399518bc5829b01559ccc.jpeg','哈哈哈','11111'),(14,8,'173200718493192019','雅思7.5分精品课程','雅思7.5分精品课程',47,1,6,'上课时间中文','上课时间英文','6109903a4f0399518bc5829b01559ccc.jpeg','哈哈哈','123445');
...
CREATE TABLE `dh_score` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='打分';

/*Data for the table `dh_score` */

insert  into `dh_score`(`id`,`type`,`uid`,`shop_uid`,`score`,`created`) values (1,1,4,0,0,1506504617),(2,1,2,0,0,1506677745),(3,1,2,0,0,1506677941),(4,1,7,1,40,1510651612),(5,1,7,1,50,1510651860);
...
CREATE TABLE `dh_sms_log` (
  ...
  KEY `created` (`created`),
  KEY `ip` (`ip`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='短信发送记录';

/*Data for the table `dh_sms_log` */

insert  into `dh_sms_log`(`id`,`flag`,`mobile`,`content`,`ip`,`created`) values (1,'verification',NULL,'Code:15445','127.0.0.1',1508384351),(2,'verification','18725796416','Code:38273','127.0.0.1',1508755600),(3,'verification','18725796416','Code:48179','127.0.0.1',1508757424);
...
CREATE TABLE `dh_sms_verify` (
  ...
  KEY `created` (`created`)
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='短信验证码记录';

/*Data for the table `dh_sms_verify` */

insert  into `dh_sms_verify`(`id`,`mobile`,`code`,`created`) values (4,'15923882847','15445',1508384351),(2,'18523563220','87301',1508134082),(5,'18725796416','48179',1508757424);
...
insert  into `dh_user`(`id`,`type`,`uid`,`username`,`nickname`,`real_name`,`avatar`,`mobile`,`mail`,`password`,`address`,`salt`,`token`,`time_out`,`ip`,`integral`,`status`,`del_status`,`login_ip`,`login_time`,`created`,`is_message`,`version`,`imei`) values (1,2,185687,'cheng6251','零零距离','四月','151071464170191.jpeg','13425778542','','8716773dd45d75071f72af288df92cbc','','26979','10d81ee3e6b7e424c30d25a886202eb0',1510887515,'127.0.0.1',3090,1,0,'127.0.0.1',1510713525,1505292648,1,0,'ADAB602A37C145D5976C69E196F03CFD'),(2,1,158566,'weixuelin','魏雪林','','150631954346095.jpeg','18523563220','6497646qw@163.com','8bd0f5ab11bb757fdbefb7d8194f8c55','','21749','1104a5503a22cd2f6c734fd59038c0eb',1511080725,'127.0.0.1',95790,1,0,'127.0.0.1',1510905323,1505293289,1,0,'72c7fbff94c4ce6b'),(3,2,158563,'kuangxin','kuangxin','四月2','150631954346095.jpeg','13896568031','','01bafc44de12208bb48680dca2ea4c16','','12532','c96f74bce28bd2cd3ae890575069bf8d',1511082266,'127.0.0.1',100220,1,0,'127.0.0.1',1510907937,1505368006,1,0,'72c7fbff94c4ce6b'),(4,1,158562,'四月个人用户','四月个人用户','','150631954346095.jpeg','15923882847','','8716773dd45d75071f72af288df92cbc','','26979','2eaceda26ee0e0f2bd49852c6d34c576',1510220079,'127.0.0.1',92030,1,0,'127.0.0.1',1510042258,1506063155,1,0,''),(5,1,158561,'123456','123456','','','15923882847','','509849f59071c6829ea94459620d9026','','59117','',0,'127.0.0.1',100000,1,0,'',0,1506395554,1,0,''),(6,1,939178,'1234567','1234567','','','15923882847','','de7a8d21b859e33d6fbee46781a4e08d','','50621','',0,'127.0.0.1',100000,1,0,'',0,1506395715,1,0,''),(7,1,939112,'17300289310','17300289310','','151071344145873.jpeg','17300289310','','8716773dd45d75071f72af288df92cbc','','26979','e3f3a61919b6e658daba700b1ebdcb1f',1511082856,'127.0.0.1',2960,1,0,'127.0.0.1',1510908998,1507874410,1,0,'1a7afa9face43399'),(8,2,939121,'17300289310','17300289310','四月3','','17300289310','','737b15b43038cfb42518a58e374d0e48','','41893','d3e861c71b8af91d51b8c43239f39da4',1510974961,'127.0.0.1',130,1,0,'127.0.0.1',1510802158,1507879382,1,0,'1a7afa9face43399'),(9,1,939125,'aaaa','aaaa','','','15923882847','','91f0d0a199ecfcfe871da82021a1740c','','71111','',0,'127.0.0.1',100,1,0,'',0,1508130313,1,0,''),(10,1,939110,'cheng6251','四月程序开发','四月学生','74c418dca7b80a5334c8a83cdce0c710.jpeg','15923882847','350375092@qq.com','2ebe69b2efe2b1886817cff244fe23dd','这里是家庭地址显示信息','92683','ac0c2c8519d8c1e6077c9c40fcd471e5',1511085008,'127.0.0.1',300,1,0,'127.0.0.1',1510889242,1510108380,1,0,''),(11,1,939111,'cheng62511','cheng62511','','','15923882847','12345','def745d7c9e2bd66dc312cd4ca47dd61','','34235','',0,'127.0.0.1',300,1,0,'',0,1510111463,1,0,''),(12,1,939135,'Ce shi@qq.bvc','Ce shi@qq.bvc','','151064961335946.jpeg','18696784295','','37adb45d9a61beca41b3d931c1eb3ec4','','70327','140fb730442712b0fb2d6edb99166848',1510822487,'14.111.53.175',80,1,0,'127.0.0.1',1510646668,1510547361,1,0,'ADAB602A37C145D5976C69E196F03CFD'),(13,1,329513,'aaa','aaa','','','15923882846','350375092@qq.com','155be0fcabfc9117c654fdfb53840368','','51500','',0,'127.0.0.1',300,1,0,'',0,1510734649,1,0,'');
...
CREATE TABLE `dh_user_course_log` (
  ...
  `order_sn` char(18) DEFAULT '0',
  `goods_id` int(10) DEFAULT '0',
  `teacher_uid` int(10) unsigned DEFAULT '0',
  `uid` int(10) unsigned DEFAULT '0',
  `start_time` int(10) unsigned DEFAULT '0',
  `end_time` int(10) unsigned DEFAULT '0',
  `credit` int(10) unsigned DEFAULT '0',
  `status` tinyint(1) unsigned DEFAULT '1' COMMENT '预约状态 0预约中 1老师同意 2老师拒绝',
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='用户课程记录';

/*Data for the table `dh_user_course_log` */

insert  into `dh_user_course_log`(`id`,`sign`,`order_sn`,`goods_id`,`teacher_uid`,`uid`,`start_time`,`end_time`,`credit`,`status`,`user_msg`,`teacher_msg`,`mobile`) values (1,1,'173139653541562130',47,8,10,1511342760,1511353560,0,1,'','',''),(2,1,'173139653541562130',47,8,10,1510824360,1510831560,0,1,'','',''),(3,1,'173139653541562130',47,8,10,1510588800,1510651560,0,1,'','',''),(4,1,'173139653541562130',47,8,10,1510910760,1510918080,0,1,'','',''),(6,1,'173175139456615895',47,8,10,1510880400,1510882200,0,0,'hhhh','','1111'),(7,1,'173175139456615895',47,8,10,1510878600,1510880400,0,0,'的说法的','',''),(8,1,'173175139456615895',47,8,10,1510882200,1510884000,0,0,'是打发打发','',''),(9,1,'173175139456615895',47,8,10,1510876800,1510878600,0,0,'大是非得失','',''),(10,1,'173175139456615895',47,8,10,1511569800,1511571600,0,0,'地方撒地方','','大师傅');
...
CREATE TABLE `dh_user_work` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `type` tinyint(1) DEFAULT '1' COMMENT '类型 1课程安排 2作业安排',
  `teacher_uid` int(11) DEFAULT '0' COMMENT '老师id',
  `goods_id` int(11) DEFAULT '0' COMMENT '课程id',
  `schedule_id` int(11) DEFAULT '0' COMMENT '对于课程表主键id',
  ...
  `del_stauts` tinyint(1) DEFAULT '0' COMMENT '状态 1删除  0未删除',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=8 DEFAULT CHARSET=utf8;

/*Data for the table `dh_user_work` */

insert  into `dh_user_work`(`id`,`type`,`teacher_uid`,`goods_id`,`schedule_id`,`title`,`content`,`annex`,`start_time`,`created`,`del_stauts`) values (2,1,8,47,0,NULL,'哈哈哈','',1510588800,1510648361,0),(3,1,8,47,0,NULL,'就将计就计','/uploadfile/test/151064883198593.doc:::口袋车接口文档 - 副本.doc,/uploadfile/test/151064883331110.doc:::口袋车接口文档.doc',1510588800,1510648833,0),(4,1,8,47,0,NULL,'hhhhh','/uploadfile/test/151065006380515.doc:::口袋车接口文档.doc',1510588800,1510650063,0),(5,1,8,47,0,NULL,'好的很哦','/uploadfile/test/151065021932294.doc:::口袋车接口文档 - 副本.doc',1510588800,1510650220,0),(6,2,8,47,0,NULL,'这里就是课程安排了哦哦哦','/uploadfile/test/151065023979776.doc:::口袋车接口文档.doc',1510588800,1510650239,0),(7,2,8,47,0,NULL,'哈哈哈好好','/uploadfile/test/151065033788524.doc:::口袋车接口文档.doc',1510588800,1510650337,0);
