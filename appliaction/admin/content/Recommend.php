...
class Recommend extends Init
{
    public function car()
    {
        ...
        $field = '*';
        $list  = table('helpCar')->where($map)->limit($offer, $pageSize)->order('id desc')->select();
    ...
    public function showCarList()
    {
        ...
        $checkValue = table('helpCar')->where('id', $id)->field('recommend_id')->value();
    ...
    public function addCarId()
    {
        ...
        $uid = table('helpCar')->where('id', $id)->field('uid')->value();
    ...
    public function service()
    {
        ...
        $field = '*';
        $list  = table('helpService')->where($map)->limit($offer, $pageSize)->order('id desc')->select();
    ...
    public function showShopList()
    {
        ...
        $checkValue = table('helpService')->where('id', $id)->field('recommend_id')->value();
        $checkValue = $checkValue ? explode(',', $checkValue) : '';
    ...
    public function addServiceId()
    {
        ...
        $uid = table('helpService')->where('id', $id)->field('uid')->value();
