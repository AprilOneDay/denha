...
MySQL - 5.5.53-log : Database - study
*********************************************************************
*/
...
/*Table structure for table `dh_ablum` */

DROP TABLE IF EXISTS `dh_ablum`;

CREATE TABLE `dh_ablum` (
...
CREATE TABLE `dh_article` (
  ...
  `description_en` varchar(255) DEFAULT NULL COMMENT '英文简介',
...
insert  into `dh_article`(`id`,`uid`,`column_id`,`model_id`,`tag`,`title`,`btitle`,`thumb`,`description`,`description_en`,`origin`,`is_show`,`is_recommend`,`is_review`,`del_status`,`created`,`hot`,`publish_time`) values (1,0,0,1,'6','Nginx 实现跨域使用字体文件','','','Nginx 实现跨域使用字体文件',NULL,'',1,1,1,0,1504970134,19,0),(2,0,0,1,'6','Nginx 跨域访问php  ','','','Access-Control-Allow-Origin 错误',NULL,'',1,0,1,0,1504970371,40,0),(3,0,0,1,'10','Html 文字内容只显示一行','','','css控制文字内容只显示一行',NULL,'',1,0,1,0,1505020972,163,0),(4,0,0,1,'8','docker 手把手教你基于官网镜像搭建mysql+php+nginx（一）','','','使用的是官网镜像mysql:5.7php:5.6nignx:last准备工作你需要先安装dockerdocker-compose并且需要有一个github账户创建本地文件apahcemysqlsrv这里用不到主要需要创建的docker文件夹文件夹下创建对应mysqlnginxphp文件里面文件内容我们需要从容器里面拷贝出来后自己调整修改OK准备工作完成了先从php开始吧抓取php需要的配置文件保存在本地方便自己以后修改创建phpDockerfile在php下创建Docker',NULL,'',1,1,1,0,1507688317,39,0),(5,0,0,1,'9','linux命令之crontab定时执行任务','','','一般情况下，我们在操作和运维VPS、服务器的时候可能会用到crontab定时任务的配置，比如定时的重启服务器、定时备份数据等操作使用的还是比较多的。这里就离不开使用crontab命令的任务配置，在这篇文章中，老左将会整理较为齐全的crontab命令使用的方法以及常用的实例操作。从上图中，我们其实就可以看到crontab具体用法。一共有6个段落，前面5个标示定时的时间设定，后面一个标示文件的路径定时执行。第一、crontab安装一般我们使用的centos或者debian发行版本都自带crontab定时软件支',NULL,'http://www.laozuo.org/7110.html',1,0,1,0,1507694379,109,0),(6,0,0,1,'3','mysql数据库主从服务器常见问题处理','','','Slave_IO_Running Checking master version',NULL,'http://blog.csdn.net/lvyongyi_2010/article/details/23336249',1,0,1,0,1507701439,14,0),(7,0,6,1,'1','学院介绍','','071ab2d5f26293a4a601ba3409dbc228.png','该团队本着“教学促科研，科研出成果，成果获奖励，成果报项目，项目奖项带队伍，教师队伍促教学”的六环紧扣原则，提出了教改成果六个“一”的目标，即主持一批课题、建设一批精品课程、出版一批规划教材、研发一组考研品牌课程、指导一批学生参加国家赛事并获奖',NULL,'',1,0,1,0,1508232750,0,0),(16,0,7,2,'1','大卫','Da Wei','6109903a4f0399518bc5829b01559ccc.jpeg','ETS官方培训师、British Council（英国教育文化协会）雅思考试年度工作坊特邀嘉宾','ETS Official Trainer, British Council (UK Education and Culture Association) IELTS Annual Workshop Specialist','',1,0,1,0,1508492185,0,0);
...
insert  into `dh_article_data`(`id`,`content`,`content_en`) values (7,'<p><img src=\"images/img01.jpg\"/></p><p>该团队本着“教学促科研，科研出成果，成果获奖励，成果报项目，项目奖项带队伍，教师队伍促教学”的六环紧扣原则，提出了教改成果六个“一”的目标，即主持一批课题、建设一批精品课程、出版一批规划教材、研发一组考研品牌课程、指导一批学生参加国家赛事并获奖该团队本着“教学促科研，科研出成果，成果获奖励，成果报项目，项目奖项带队伍，教师队伍促教学”的六环紧扣原则，提出了教改成果六个“一”的目标，即主持一批课题、建设一批精品课程、出版一批规划教材、研发一组考研品牌课程、指导一批学生参加国家赛事并获奖</p><p>该团队本着“教学促科研，科研出成果，成果获奖励，成果报项目，项目奖项带队伍，教师队伍促教学”的六环紧扣原则，提出了教改成果六个“一”的目标，即主持一批课题、建设一批精品课程、出版一批规划教材、研发一组考研品牌课程、指导一批学生参加国家赛事并获奖</p>',NULL);
...
insert  into `dh_article_teacher`(`id`,`teacher_uid`,`position`,`position_en`) values (16,0,'深知高数讲师','Know high number of lecturers');
...
CREATE TABLE `dh_column` (
  ...
  `url` varchar(150) DEFAULT '' COMMENT '跳转url',
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 COMMENT='栏目列表';

/*Data for the table `dh_column` */

insert  into `dh_column`(`id`,`parentid`,`model_id`,`name`,`bname`,`description`,`is_show`,`url`,`module`,`controller`,`action`,`sort`,`created`) values (1,0,1,'国际商学院','国际商学院','',1,'/content/article_list/lists','content','article_list','lists',0,1508144704),(2,0,1,'高中部','高中部','',1,'/content/article_list/lists','content','article_list','lists',0,1508144724),(3,0,1,'恒鼎社区','恒鼎社区','',1,'/content/article_list/lists','content','article_list','lists',0,1508144740),(4,0,1,'入学必读','入学必读','',1,'/content/article_list/lists','content','article_list','lists',0,1508144771),(5,0,1,'关于我们','关于我们','',1,'/content/article_list/lists','content','article_list','lists',0,1508144802),(6,1,1,'学院简介','学院简介','',1,'/content/article_list/lists','content','article_list','lists',0,1508148724),(7,1,2,'恒鼎商学院教研团队','恒鼎商学院教研团队','',1,'/content/article_list/lists','content','article_list','lists',0,1508148724),(8,1,1,'澳洲大学课程','澳洲大学课程','',1,'/content/article_list/lists','content','article_list','lists',0,1508148724),(9,1,1,'留学部','留学部','',1,'/content/article_list/lists','content','article_list','lists',0,1508148724),(10,5,1,'恒鼎学院简介','恒鼎学院简介','',1,'/content/article_list/lists','content','article_list','lists',0,1508228818),(11,5,1,'联系我们','联系我们','',1,'/content/article_list/lists','content','article_list','lists',0,1508228818),(12,5,1,'合作院校','合作院校','',1,'/content/article_list/lists','content','article_list','lists',0,1508228818),(13,2,1,'部门简介','','',1,'/content/article_list/lists','content','article_list','lists',0,1508228969),(14,2,1,'高中部团队','','',1,'/content/article_list/lists','content','article_list','lists',0,1508228969),(15,2,1,'直播课程','','',1,'/content/article_list/lists','content','article_list','lists',0,1508228969),(16,2,1,'视频课程','','',1,'/content/article_list/lists','content','article_list','lists',0,1508228969),(17,2,1,'学霸共享计划','','',1,'/content/article_list/lists','content','article_list','lists',0,1508228969);
...
insert  into `dh_console_group`(`id`,`name`,`power`,`status`) values (1,'超级管理员','1,2,3,4,5,35,6,7,8,10,17,11,12,13,14,15,16,18,28,19,20,21,22,23,24,25,26,27,29,30,31,33,34,32,38,39,36,37',1),(2,'运营组','1,2,35,10,17,13,14,15,16,18,28,19,20,21,22,23,24,25,26,27,29,30,31,33,34,32',1);
...
insert  into `dh_console_parameter`(`id`,`type`,`name`,`value`,`option`) values (1,1,'网站标题','4','');
...
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8 COMMENT='抵扣卷列表';
...
/*Table structure for table `dh_goods` */

DROP TABLE IF EXISTS `dh_goods`;
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='商品总表';

/*Data for the table `dh_goods` */
...
insert  into `dh_shop_hot_log`(`id`,`uid`,`num`,`time`) values (17,7,1,'2017-10-13'),(16,1,10,'2017-10-13'),(15,2,5,'2017-10-13'),(14,4,1,'2017-10-13'),(13,3,9,'2017-10-13'),(12,3,1,'2017-10-12'),(11,1,1,'2017-10-11');
...
CREATE TABLE `dh_sms_verify` (
  ...
  `code` varchar(10) DEFAULT '0' COMMENT '值',
  `created` int(10) unsigned DEFAULT '0' COMMENT '创建时间戳',
  PRIMARY KEY (`id`),
  UNIQUE KEY `mobile` (`mobile`),
  KEY `created` (`created`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='短信验证码记录';

/*Data for the table `dh_sms_verify` */

insert  into `dh_sms_verify`(`id`,`mobile`,`code`,`created`) values (1,'15923882847','79836',1508379063),(2,'18523563220','81301',1508133041);
...
insert  into `dh_user`(`id`,`type`,`username`,`nickname`,`avatar`,`mobile`,`mail`,`password`,`salt`,`token`,`time_out`,`ip`,`integral`,`status`,`del_status`,`login_ip`,`login_time`,`created`,`is_message`,`version`,`imei`) values (1,2,'cheng6251','四月工作室','150788850753401.png','13425778542','','7df8faa9a5f71811689662131b7f9fe5','45452','2d39e06e5fefcb1e3ff98e11ed9d1c4f',1508298828,'127.0.0.1',100000,1,0,'127.0.0.1',1508120627,1505292648,1,0,''),(2,1,'weixuelin','魏雪林','150631954346095.jpeg','18523563220','6497646qw@163.com','f6b81aa9bcdeb6e01455a3d61e16f4d7','21749','582156a806c841009655d2d0315f29ad',1508305841,'127.0.0.1',95590,1,0,'127.0.0.1',1508133022,1505293289,1,0,'ceadcf79f7ed11e1'),(3,2,'kuangxin','kuangxin','150631954346095.jpeg','13896568031','','01bafc44de12208bb48680dca2ea4c16','12532','6745348efd96431e0fb52092a3298bd6',1508305582,'127.0.0.1',100090,1,0,'127.0.0.1',1508126495,1505368006,1,0,'ceadcf79f7ed11e1'),(4,1,'四月个人用户','四月个人用户','150631954346095.jpeg','15923882847','','ffbb0d9f227b1d1df90513144b3b73ad','14526','bfbd1b567d4cfc4e211e7b3d29a50e1a',1508293183,'127.0.0.1',98000,1,0,'127.0.0.1',1508120383,1506063155,1,0,''),(5,1,'123456','123456','','15923882847','','509849f59071c6829ea94459620d9026','59117','',0,'127.0.0.1',100000,1,0,'',0,1506395554,1,0,''),(6,1,'1234567','1234567','','15923882847','','de7a8d21b859e33d6fbee46781a4e08d','50621','',0,'127.0.0.1',100000,1,0,'',0,1506395715,1,0,''),(7,1,'17300289310','17300289310','','17300289310','','8716773dd45d75071f72af288df92cbc','26979','3cb5671c525c838bd4671d49678d89ae',1508052519,'127.0.0.1',130,1,0,'127.0.0.1',1507879719,1507874410,1,0,''),(8,2,'17300289310','17300289310','','17300289310','','737b15b43038cfb42518a58e374d0e48','41893','110fcf64bf37d413505bb236870a405f',1508062931,'127.0.0.1',130,1,0,'127.0.0.1',1507880153,1507879382,1,0,'1a7afa9face43399'),(9,1,'aaaa','aaaa','','15923882847','','91f0d0a199ecfcfe871da82021a1740c','71111','',0,'127.0.0.1',100,1,0,'',0,1508130313,1,0,'');
...
insert  into `dh_user_shop`(`id`,`uid`,`goods_num`,`orders`,`name`,`avatar`,`credit_level`,`woker_time`,`address`,`category`,`ablum`,`ide_ablum`,`is_ide`,`is_message`,`status`,`is_recommend`) values (1,1,8,0,'四月工作室','150788850753401.png',46,'9点-10点','这里是店铺地址信息','1','','150788710993696.png',0,0,1,1),(2,3,1,0,'kuangxin','150588957988857.jpeg',49,'09:00-18:00','重庆市南岸区','20,22','150536187327122.jpeg,150536187343181.png','150588960214710.png',1,1,1,1),(3,8,0,0,'17300289310','',50,'','','0','','',1,1,1,0);
